...
function endGame() {
  ...
  gen_buttons.style.display = "none";
...
getRandomCaracter.addEventListener("click", function getRandomCaracter() {
  ...
  //console.log("idx:"+indexCaracter);
  if (indexCaracter === caractere.length - 1) {
    endGame();
...
gen_buttons.addEventListener("click", (event) => {
 // console.log("Nr curent:" + indexCaracter);
  //console.log("Nr total:" + caractere.length);
...
playAgain.addEventListener("click", (event) => {
  ...
  gen_buttons.style.display = "flex";
  caractere = _.shuffle(caractere);
  indexCaracter = 0;
  score = 0;
